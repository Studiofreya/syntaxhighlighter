...
class SyntaxHighlighter {
	...
	function __construct() {
		...
		wp_register_style(  'syntaxhighlighter-theme-sfparent',   plugins_url( $this->shfolder . '/styles/shThemeSfparent.css',   __FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
